...
// campaigns/abstimmung/Gallery.js
try { (() => {
...
function Lightbox({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onError: ev => {
      ...
      if (p) {
        p.style.background = '#EDEAE3';
        p.style.display = 'flex';
        p.style.alignItems = 'center';
        p.style.justifyContent = 'center';
        p.style.minHeight = '200px';
        if (!p.querySelector('.bild-fehlt')) {
          const s = document.createElement('span');
          s.className = 'bild-fehlt';
          s.textContent = 'Bild nicht verfügbar';
          s.style.cssText = 'font-size:12px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:#9A9A97';
          p.appendChild(s);
        }
      }
    },
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "campaigns/abstimmung/Gallery.js", error: String((e && e.message) || e) }); }

// campaigns/abstimmung/lib.js
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "campaigns/abstimmung/lib.js", error: String((e && e.message) || e) }); }

// campaigns/abstimmung/sections.js
try { (() => {
...
// campaigns/malwettbewerb/UploadForm.js
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "campaigns/malwettbewerb/UploadForm.js", error: String((e && e.message) || e) }); }

// campaigns/malwettbewerb/lib.js
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "campaigns/malwettbewerb/lib.js", error: String((e && e.message) || e) }); }

// campaigns/malwettbewerb/sections.js
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "campaigns/malwettbewerb/sections.js", error: String((e && e.message) || e) }); }
